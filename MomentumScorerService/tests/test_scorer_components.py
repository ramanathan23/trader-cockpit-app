"""
Per-component tests for the unified scorer (momentum + trend).

See test_scorer_volatility_structure.py for the other two components.
"""
...
from tests._scorer_fixtures import flat, trending_up
