...
type Row = HoldingRow & { account_id: string };

export function holdingsOf(accounts: DashboardAccount[]): Row[] {
  return accounts.flatMap(a => a.holdings.map(h => ({ ...h, account_id: a.account_id })));
}
