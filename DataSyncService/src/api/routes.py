...
from ._zerodha_routes import router as _zerodha_router
from ._zerodha_history_routes import router as _zerodha_history_router
...
router.include_router(_zerodha_router)
router.include_router(_zerodha_history_router)
